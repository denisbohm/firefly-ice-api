...
public class FDDetour {
	...
	void detourError(String reason) {
        ...
        userInfo.put("com.fireflydesign.device.detail", FDString.format("detour error %s: state %u, length %u, sequence %u, data %u", reason, state, length, sequenceNumber, buffer.size()));
