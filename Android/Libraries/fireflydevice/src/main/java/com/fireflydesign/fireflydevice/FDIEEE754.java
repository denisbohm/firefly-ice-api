...
public class FDIEEE754 {

    public static int floatToUint32(float value) {
        return Float.floatToIntBits(value);
    }

    public static float uint32ToFloat(int value) {
        return Float.intBitsToFloat(value);
    }

    public static short floatToUint16(float fval) {
    ...
    public static float uint16ToFloat(short hbits) {
